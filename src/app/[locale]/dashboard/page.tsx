  ...
  return (
    <UnlockedDashboard
      ...
      copy={{
        ...
        toolkitTitleH2: t("toolkitTitleH2"),
        codingModelsLabelH2: t("codingModelsLabelH2"),
        chatbotModelLabelH2: t("chatbotModelLabelH2"),
        ...
        projectGithubLabel: t("projectGithubLabel"),
         ...
         techSecondaryTitle: t("techSecondaryTitle"),
        techCategories: {
        ...
        techItems: {
          ...
          go: { name: t("techItems.go.name"), description: t("techItems.go.description") },
          chi: { name: t("techItems.chi.name"), description: t("techItems.chi.description") },
          htmx: { name: t("techItems.htmx.name"), description: t("techItems.htmx.description") },
          sqliteWal: { name: t("techItems.sqliteWal.name"), description: t("techItems.sqliteWal.description") },
          hetzner: { name: t("techItems.hetzner.name"), description: t("techItems.hetzner.description") },
          caddy: { name: t("techItems.caddy.name"), description: t("techItems.caddy.description") },
          systemd: { name: t("techItems.systemd.name"), description: t("techItems.systemd.description") },
          letsEncrypt: { name: t("techItems.letsEncrypt.name"), description: t("techItems.letsEncrypt.description") },
          githubActions: { name: t("techItems.githubActions.name"), description: t("techItems.githubActions.description") },
          r2Rclone: { name: t("techItems.r2Rclone.name"), description: t("techItems.r2Rclone.description") },
        },
